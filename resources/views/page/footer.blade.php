<footer class="bg-base-300">
    <div class="w-full bg-neutral/90 flex justify-evenly px-10 items-center text-base-content">
    ...
    <div class="grid grid-cols-4 px-8 py-10 bg-secondary/80">
        <figure class="w-48">
            <img src="/logo.png" alt="Logo UTI Soluções">
        </figure>

        <div>
            <h4 class="text-lg font-bold uppercase">Serviços</h4>
        </div>

        <div>
            <h4 class="text-lg font-bold uppercase">Link rápidos</h4>
        </div>

        <div>
            <h4 class="text-lg font-bold uppercase">Contato</h4>
        </div>
    </div>

    <span class="text-xs block text-center py-4 bg-neutral/80">© 2025 UTI Soluções em Informática. Todos os direitos reservados.</span>
</footer>
